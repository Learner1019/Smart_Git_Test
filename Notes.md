...
- **对FCT三个runnable模块运作的一些理解**
  ...
  - **MainProc**:
    ...
    - controller执行最主要最宏观的逻辑，包括processor->functiongroup->decisionmaker->behaviorditributor
  - **PostProc**:
    - 代码没找到，准备重看一下视频
...
### NM、E2E数据标注工作（紧急）
  ...
  - **进度**:
    ...
    - \\bosch.com\dfsRB\DfsCN\loc\Wx8\Dept\BCSC\01_Common\Devops\AI_RE\标注数据  20250328\SAIC_IM_S12LOversea\CR5CB\00 Customer
